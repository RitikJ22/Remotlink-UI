      ...
      >
        <div className="w-full h-[103px] lg:h-[69px] border-b border-solid border-white border-opacity-20 bg-opacity-33 bg-[#16131E54] light:bg-brand light:bg-opacity-[68] purple:bg-primary shadow-md backdrop-blur-[8px] flex  items-center justify-between overflow-y-scroll no-scrollbar">
          <div className="flex  items-center justify-center ">
            ...
            <div className="mr-4">
            <h1 className="text-white light:text-black purple:hidden font-Lusitana light:font-SourceSans text-base font-bold leading-6 w-60 sm:w-72 lg:w-96 pl-3 md:pl-6 ">
              Swargiya Dadasaheb Kalmegh Smruti Dental College & Hospital
            </h1>
            </div>
            <h1 className="hidden purple:block text-[#6F1AB6]  text-base font-Sora font-bold leading-6 w-56 sm:w-72 lg:w-96 pl-3 md:pl-6">
          ...
          <div className="lg:hidden mr-6 md:mr-20">
            <img src={menu_icn} alt="menu" className="light:hidden purple:hidden"/>
        ...
        <div>
          ...
          <div className="pt-12  sm:pt-32 lg:pt-36 purple:pt-28 purple:sm:pt-32 purple:lg:pt-36 flex mx-auto items-center justify-normal  ">
            {/* <img src={library_cover} alt="library cover" className="light" /> */}
            <div className="bg-pic light:bg-pic-light purple:bg-pic-purple purple:ellipse ">
            
            </div>
            <div className="flex   items-center justify-between relative right-56">
            <div className="hidden purple:block ellipse-icon w-[43px] h-[43px] absolute right-[159px]"></div>
              <img src={books} alt="books icon" className=""/>
...
{/* 
        ...
        <div className="flex  items-center justify-center mt-[89px] pb-36  flex-wrap">
          ...
          <div className="mt-5 mx-4 relative ">
            <img src={video_pic} alt="video icon" className="w-full h-auto hidden sm:block"/>
            <img src={video_pic_mobile} alt="video icon mobile" className="w-full h-auto sm:hidden"/>
            <img
              className="absolute bottom-[157px] left-48 sm:left-64  h-auto"
              src={circle}
              alt="circle icon"
            />
          </div>
