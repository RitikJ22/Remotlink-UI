...
const Showcard = (props) => {
  const classes=`w-[184px] md:w-[291px] h-[257px] rounded-[5px] flex flex-shrink-0 flex-col border items-center justify-evenly border-solid ${props.borderclr}  border-opacity-14  ${props.bgcolor}  mr-5 mt-3`;
